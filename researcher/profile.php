    ...
    <div class="col-md-8 col-lg-6">
      ...
      <div class="card profile-card shadow-lg border-0 rounded-3">
        ...
        <div class="card-header text-white text-center py-4"
          ...
          <h3 class="mb-0">👋 Welcome, <strong><?php echo htmlspecialchars($user['name'] ?? 'Contributor'); ?></strong>!</h3>
        </div>

        <div class="card-body text-center p-5">
          <!-- Profile Image -->
          <?php $img = !empty($user['image']) ? htmlspecialchars($user['image']) : null; ?>
          <?php if ($img) { ?>
            <img src="../uploads/<?= $img; ?>"
                 class="rounded-circle shadow mb-3 profile-img"
                 width="120" height="120" alt="User">
          <?php } else { ?>
            <div class="rounded-circle shadow mb-3 profile-img d-inline-flex align-items-center justify-content-center"
                 style="width:120px;height:120px;background:#fff;color:#5B6B61;">
          ...
          <div class="row justify-content-center g-3 mb-4">
           ...
           <div class="mt-2">
            <a href="../uploads/<?= urlencode($user['certificate']) ?>" class="btn btn-outline-primary me-2" style="border-radius:30px; padding:10px 18px;" target="_blank" rel="noopener">
              view certificates
            </a>
          ...
          <div class="mt-2">
            ...
            <a href="researcher_achievements.php" class="btn btn-success"
               style="border-radius:30px; padding:10px 18px;">
              🏆 My Achievements
            </a>
          </div>
