...
<body style="background:#E9F2EC; min-height:100vh;">
  ...
  <div style="min-height:100vh; display:flex; justify-content:center; align-items:center; padding:1rem;">
    <div class="card shadow-sm"
      ...
      <h3 class="text-center" style="margin-bottom: .75rem; color:#282F34; letter-spacing:.2px;">Feedback</h3>
      <p class="text-center" style="margin-top:-.25rem; margin-bottom:1.25rem; color:#5B6B61; font-size:.95rem;">
        Share thoughts to improve RareTrack
      </p>

      <form method="post" action="addfeedback_action.php" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="phone" class="form-label" style="color:#5B6B61; letter-spacing:.1px;">Feedback</label>
          <textarea class="form-control" id="phone" name="feedback" placeholder="Write feedback..." required
